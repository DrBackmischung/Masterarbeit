...
public class BreitensucheRace {
	...
	public static void main(String[] args) {
		...
		System.out.println(iterativ(map, "SB_CFD_PRJ_PROJECT_V4", "cfd_dummy"));
		System.out.println();
		...
		result = new ArrayList<>();
		System.out.println(beschraenktIterativ(map, "SB_CFD_PRJ_PROJECT_V4", "cfd_dummy"));
		System.out.println();
		...
		map = List2TreeByParents.getMapMiddle();
		result = new ArrayList<>();
		System.out.println(nichtDeterministischIterativ(map, "SB_CFD_PRJ_PROJECT_V4", "cfd_dummy"));
		System.out.println();
	...
	public static long iterativ(HashMap<String, Node> map, String s, String suche) {
	...
	public static long beschraenktIterativ(HashMap<String, Node> map, String s, String suche) {
	...
	public static long nichtDeterministischIterativ(HashMap<String, Node> map, String s, String suche) {
	...
	public static long rek = 0L;
	
	public static long rekursiv(HashMap<String, Node> map, String s, String suche) {
	...
	public static long nDRek = 0L;
	
	public static long nichtDeterministischRekursiv(HashMap<String, Node> map, String s, String suche) {
	...
	private static void nichtDeterministischRekursiv_alg(Queue<Node> q, HashMap<String, Node> map, String suche) {
		...
		Node n = (Node) q.poll();
		if(n.content.contains(suche)) {
			nDRek = System.currentTimeMillis();
		}
